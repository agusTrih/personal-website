    ...
    <div className="max-w-4xl mx-auto px-4">
      <RoughNotationGroup show={isFontReady}>
        <Heading as="h1" sizes="xxl" className="mb-10">
          ...
          <Highlight color={pallete.primary}>Frontend</Highlight> Engineer with
        ...
        <Paragraph>
          ...
          <Highlight color={pallete.netral}>
        ...
        <Paragraph>
          ...
          , I constantly seek opportunities to enhance my skills and stay
          abreast of the latest technologies.
        </Paragraph>
        <Paragraph>
          Throughout my professional journey, I have consistently delivered
          <Highlight color={pallete.netral}> high-quality work</Highlight>{' '}
          within deadlines, maintaining a track record of{' '}
          <Highlight color={pallete.secondaryVariants}>
        ...
        <Paragraph>
          ...
          continuous improvement, I am confident in my ability to make a
          valuable contribution as a frontend engineer.
        </Paragraph>
        <Paragraph>
          {' '}
          I am excited to leverage my skills and knowledge to craft innovative
